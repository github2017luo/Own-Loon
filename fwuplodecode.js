const $ = new Env('互助码')
const zd_shareCode = $.getdata('zd_shareCode') || 'kziyh3nw3tpxz25qkln3xdez5g5sfkxcdwciomy';
const nc_shareCode = $.getdata('nc_shareCode') || 'cc2dc09626d14b9d8a8e4c5e2f052447';
const mc_shareCode = $.getdata('mc_shareCode') || 'MTAxODcxOTI2NTAwMDAwMDAyNzY4MTA5OQ==';

const $ = new Env('互助码')
const zd_shareCode = $.getdata('zd_shareCode') || 'e7lhibzb3zek3cq2dk2fk5a5ty3ufzbk5gwfmai';
const nc_shareCode = $.getdata('nc_shareCode') || '2f978fdf28f14ee29175efe6d3de56f2';
const mc_shareCode = $.getdata('mc_shareCode') || 'MTAxODc2NTEzNTAwMDAwMDAzMDMwMzA4Nw==';
